...
### ByRoleId
```
Set-TmdsApiKey [-ApiKeyId <Int32>] [-Active <Boolean>] [-Created <Int64>] [-Description <String>]
 [-ExpiryDate <Int64>] [-KeyName <String>] [-LastSignIn <Int64>] [-Locale <String>] [-RoleID <Int32>]
 [-TimeZone <String>] [-UnlockTime <Int64>] [-UnsuccessfulSignInAttempts <Int32>] [<CommonParameters>]
```

### ByRoleName
```
Set-TmdsApiKey [-ApiKeyId <Int32>] [-Active <Boolean>] [-Created <Int64>] [-Description <String>]
 [-ExpiryDate <Int64>] [-KeyName <String>] [-LastSignIn <Int64>] [-Locale <String>] [-RoleName <String>]
 [-TimeZone <String>] [-UnlockTime <Int64>] [-UnsuccessfulSignInAttempts <Int32>] [<CommonParameters>]
```
